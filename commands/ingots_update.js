    ...
    if (hasPermission) {
      ...
      if (cellInfo.value) {
        ...
        if (updateSuccess) {
          ...
          await interaction.editReply(`Updated ${playerName}'s ingots to ${newIngots.toLocaleString("en-US")} <:Ingot:1130689515372159136>\n(Previous Value: ${previousIngots.toLocaleString("en-US")} <:Ingot:1130689515372159136>)`);
        }
      } else {
